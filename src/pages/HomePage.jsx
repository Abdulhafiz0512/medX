...
import { Search, Filter, Star, MapPin, Stethoscope, Building2, Calendar, Clock, Heart, Phone, ArrowUp } from 'lucide-react';
...
const healthPosts = [
  ...
  {
    id: 3,
    title: 'Kundalik suv ichishning ahamiyati',
    excerpt: 'Kuniga 8 stakan suv ichish sog\'liq uchun qanchalik muhimligini bilib oling...',
    category: 'Umumiy sog\'liq',
    date: '23 Iyun, 2025',
    image: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'
  },
  {
    id: 4,
    title: 'Uyqu rejimini yaxshilash usullari',
    excerpt: 'Sifatli uyqu uchun 7-8 soat uxlash va uyqu rejimini saqlash bo\'yicha maslahatlar...',
    category: 'Uyqu',
    date: '21 Iyun, 2025',
  ...
  {
    id: 5,
    title: 'Stressni boshqarish texnikalari',
    excerpt: 'Kundalik hayotda stressni kamaytirish va ruhiy salomatlikni saqlash usullari...',
    category: 'Ruhiy sog\'liq',
    date: '19 Iyun, 2025',
    image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'
  },
  {
    id: 6,
    title: 'Mashqlar va jismoniy faollik',
    excerpt: 'Kuniga 30 daqiqa mashq qilish sog\'liq uchun qanday foydali ekanligi haqida...',
...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      {/* Health Tips */}
      <section className="mb-8" id="health-tips">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-900">Sog'liq maslahatlari</h2>
          <Button 
            variant="ghost" 
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 mb-4">
          <div className="text-center mb-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Sog'lom hayot uchun foydali maslahatlar</h3>
            <p className="text-gray-600">Mutaxassislarimiz tomonidan tavsiya etilgan sog'liq maslahatlari</p>
          </div>
        </div>
        <div className="space-y-4">
          {healthPosts.map(post => (
            <div key={post.id} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex">
                <img 
                  src={post.image} 
                  alt={post.title} 
